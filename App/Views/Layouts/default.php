...
<head>
    ...
    <?php else: ?>
        <link rel="shortcut icon" href="<?php echo BASEURL;?>/public/img/blue-dollar.png"/>
    <?php endif; ?>
    ...
    <?php else: ?>
        <meta property="og:title" content="PDV">
        <meta property="og:site_name" content="PDV">
    <?php endif; ?>

    <meta property="og:description" content="PDV">
