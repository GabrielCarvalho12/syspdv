...
$route->get('pdvDiferencial/colocarProdutosNaMesaCodBarra/{idProduto}', 'PdvDiferencialController@colocarProdutosNaMesaCodBarra');
...
$route->get('pdvDiferencial/verificarquantidadeDeUmProdutoEstoqueCodBarra/{idProduto}/{quantidade}',
    'PdvDiferencialController@verificarquantidadeDeUmProdutoEstoqueCodBarra');
